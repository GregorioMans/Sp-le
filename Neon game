...
<script>
 ...
 BugImg.src = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSrH887qAB8AsDNbLEiHl9r7KfOP-WcQHlQng&usqp=CAU";         // The bug

 var melon_x = 0;
 var melon_y = 0;
 var MelonImg = new Image();
 MelonImg.src = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTg3-otbCNuE73r0xu1yL2vukEgTwIQUb4SJQ&usqp=CAU";  // The melon
